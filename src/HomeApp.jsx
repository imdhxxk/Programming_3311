...
function ButtonPageApp({ setPage }) {
    return (
        ...
        <h1>App 목록</h1>
        <ul>
            <li><button style={{width:"200px" , height:"200px", fontSize:"1.5rem"}}
            onClick={() => setPage("counterapp")}>CounterApp</button>
            </li>    
            
            <li><button style={{width:"200px" , height:"200px", fontSize:"1.5rem"}}
            onClick={() => setPage("todolistapp")}>TodoListApp</button>
            </li>    
        </ul>
        </>
    )
...
export default function HomeApp() {
    ...
    return (
        <>
            ...
            {/* page가 home이 아니면, home으로 가는 버튼만들자 */}
            {page !== 'home' &&
                <button
